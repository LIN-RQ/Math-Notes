---
layout: default
title: Extrema with Constraint - Lagrange Multiplier
---
...
If the partial derivatives of $\mathcal{L}$ are zero, then we have different possible combinations of $(x,y,\lambda)$: 

$$(0,\pm \, 2,2), \quad (\pm \, 2,0,1), \quad(0,0,\lambda \in \mathbb{R})$$
...
& \partial_y f = 2y - 4\lambda \end{split} $$
...
Substituting this into the constraint, we obtain $\lambda = 2$. Thus the function $f(x,y,z)$ has an extremum 

$$f_{max} = \lambda^2 - \frac{\lambda^2}{4} = 3$$ 

It is a local maximum because the quadratic form
